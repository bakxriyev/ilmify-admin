                    ...
                    <tbody>
                      {payments.map((p, idx) => (
                        <tr key={p.id} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="hidden lg:table-cell p-2 md:p-3 text-left text-[10px] text-gray-500 max-w-[120px] truncate cursor-pointer hover:text-blue-600 hover:underline" onClick={() => p.note && setNoteDialog(p.note)} title={p.note || ''}>
                            {p.note || '-'}
                          </td>
                        </tr>
                      ))}
